...
const postSettingsData = () => {
    let url = `http://localhost:3002/users/settings`
...
const userSettingsFetch = () => {
    let userSettingsURL = `http://localhost:3002/users/settings`
...
const changePassword = () => {
    ...
    form.addEventListener("submit", () => {
        ...
        if(password === newpassword){
            ...
            let userURL = `http://localhost:3002/users/password`
...
const deleteUserAccount = () => {
    ...
    deleteButton.addEventListener("click", () => {
        let userURl = `http://localhost:3002/users/register`
